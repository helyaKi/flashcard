...
namespace Backend.Migrations
{
    ...
    [Migration("20250830172014_AddUsersTable")]
            ...
            modelBuilder.Entity("Flashcard.Backend.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PasswordHash = "$2a$11$fgOT7gEu2y/DvQDku/XUqugxSMntOmBXt0vdKxSa5cKNJPPD1MooS",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            PasswordHash = "$2a$11$OTGPEKBzWcPaKM5lWFDkw.9wJB.g/rjHkRMbqdp8g8cSSxLpIXLKW",
                            Role = "User",
                            Username = "user"
                        });
                });
